...
Unutmangki, agar siz bir versiyani yaxshi tushunib, o'rganib olsangiz, boshqa versiyaning farqlarini va undan foydalanishni osongina o'rganib olasiz. Qiyin  tomoni bu Python asoslarida dasturlashni o'rganish va tushunishdir. The hard part is learning programming and understanding the basics of Python language itself. Bu kitobdagi bizning maqsadimiz - That is our goal in this book, and once you have achieved that goal, you can easily use Python 2 or Python 3 depending on your situation.
